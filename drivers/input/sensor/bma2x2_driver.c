		...
		const char *buf, size_t count)
{
	...
	do{		
		...
		SENSOR_LOG("===============moved x=============== timeout = %d",timeout_shaking);
		...
		const char *buf, size_t count)
{
	...
	do{
		...
		SENSOR_LOG("===============moved y=============== timeout = %d",timeout_shaking);
		SENSOR_LOG("(%d, %d, %d) (%d, %d, %d)", acc_cal_pre.x,	acc_cal_pre.y,	acc_cal_pre.z, acc_cal.x,acc_cal.y,acc_cal.z );
		...
		const char *buf, size_t count)
{
	...
	do{
		...
		SENSOR_LOG("===============moved z=============== timeout = %d",timeout_shaking);
		SENSOR_LOG("(%d, %d, %d) (%d, %d, %d)", acc_cal_pre.x,	acc_cal_pre.y,	acc_cal_pre.z, acc_cal.x,acc_cal.y,acc_cal.z );
