	...
	const char *buf, size_t count)
{
	...
	switch (pattern_id) {
#if defined(CONFIG_MACH_MSM8916_STYLUSC_SPR_US) || defined(CONFIG_MACH_MSM8916_C90NAS_SPR_US) || defined(CONFIG_MACH_MSM8916_PH1_VZW) || defined(CONFIG_MACH_MSM8916_PH1_SPR_US) || defined(CONFIG_MACH_MSM8916_PH1_GLOBAL_COM)
